    ...
    if element.tag == "node" or element.tag == "way" :
        ...
        for child in element:
            ...
            if 'k' in child.attrib.keys() and (child.attrib['k']=="addr:street") :
                dic["street"]=child.attrib['v']
                print dic['street']
            if 'k' in child.attrib.keys()  and (child.attrib['k']=="addr:housenumber"): 
                dic["housenumber"]=child.attrib['v']
                print dic['housenumber']
            if 'k' in child.attrib.keys() and child.attrib['k']=='amenity' :
                node['amenity']=child.attrib['v']
            if 'k' in child.attrib.keys() and child.attrib['k']=="cuisine": 
                node['cuisine']=child.attrib['v']
            if 'k' in child.attrib.keys() and child.attrib['k']=="name" :
                node['name']=child.attrib['v']
            if 'k' in child.attrib.keys() and child.attrib['k']=="phone":
